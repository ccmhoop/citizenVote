...
export default function ProposeProjectMenu() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/api/v1/auth/auth/project/image",
        formDataToSend,
        {
          headers: {
  ...
  <form onSubmit={handleSubmit}>
    <div className="max-w-md mx-auto mt-8 mb-8 p-4 border rounded-lg shadow-lg bg-slate-900">
      <h2 className="text-2xl font-semibold mb-4 text-gray-200">New project</h2>
      ...
      <div className="max-w-md mx-auto mt-8 mb-8 p-4 border rounded-lg shadow-lg bg-slate-900">
       <h2 className="text-2xl font-semibold mb-4  text-gray-200">
        ...
        {/* Voeg hier de rest van je formuliervelden toe zoals in je oorspronkelijke code */}
...
// data.append('project', `{  "title" : "${}",\n "description" : "Hallo dit is een test"}`, {contentType: 'application/json'});

// let config = {
//   method: 'post',
//   maxBodyLength: Infinity,
//   url: 'http://localhost:8080/api/v1/auth/auth/project/image',
//   headers: {
//     ...data.getHeaders()
//   },
//   data : data
