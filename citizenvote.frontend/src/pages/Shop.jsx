...
export default function Shop() {
  ...
  return (
    <div className="w-[100%] min-h-[88vh] flex justify-center items-start flex-wrap gap-2 bg-gradient-to-br from-indigo-800 to-rose-600">
      <div className="  min-w-[40vw] max-w-[95vw]   h-[88vh] flex flex-col justify-start items-center rounded-xl bg-white/80 my-4  overflow-y-scroll ">
        ...
        <div className="flex justify-start items-start flex-wrap h-fit mx-auto">
          {products.map((item) => (
