...
export default function Home() {
  return (
    <div className="h-fit w-screen flex justify-start items-center flex-col">
      <img
        className="h-auto max-h-[92.5vh]  w-screen flex justify-center items-center object-cover object-top"
        src={banner}
        alt=""
      />
       <div className="h-10 w-[100%] text-white flex items-center border-b-2 border-gray-600 shadow-lg bg-slate-900"><div className="m-auto">Gemeente Amersfoort</div></div>
