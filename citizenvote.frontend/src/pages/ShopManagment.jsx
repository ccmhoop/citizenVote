...
export default function ShopManagment() {
  ...
  return (
    <div className="w-[100%] min-h-[88vh] flex justify-center items-start flex-wrap gap-2 bg-gradient-to-br from-indigo-800 to-rose-600">
      <div className="  min-w-[40vw] max-w-[95vw]  h-[88vh] flex flex-col justify-center items-center rounded-xl bg-white/80 overflow-y-scroll overflow-x-hidden  my-2 p-2">
        {selected ? (
